...
PFIC flowup pipeline: final flowup construction, auto election D,
lookthrough adjustments, distribution line exclusion, custom footnotes.
...
def register_reclass_unblocked(spark: SparkSession, cfg: dict) -> DataFrame:
