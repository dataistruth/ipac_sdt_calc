...
def run_load_allocation_input(
    ...
    **kwargs,
    ...
    initialize_checkpoint_V2(cfg, cfg["checkpoint_mode"])
        ...
        if parquet_tables:
            try:
                ...
                for table_name, value in run_parallel(
                    write_tasks,
                    "flow-up-writes",
                    max_threads=cfg.get("max_threads"),
                ):
                ...
                stored_result.update(
                    {
                        ...
                        "max_threads": cfg.get("max_threads"),
                        "checkpoint_mode": cfg.get("checkpoint_mode"),
    ...
    return {
        ...
        "max_threads": cfg.get("max_threads"),
        "checkpoint_mode": cfg.get("checkpoint_mode"),
        "checkpoint_timings": cfg.get("_checkpoint_v2_activity", []),
        "plan_profile": plan_profile,
    }