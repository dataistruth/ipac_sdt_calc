...
track_plan`` / ``plan_profile_report``) keep working unchanged. All logic lives
in the shared package ``Source/AllocationV2/plan_profiler``; this file only
forwards its public API,
